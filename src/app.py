...
activities = {
    ...
    "Basketball Club": {
        "description": "Team training, pickup games, and skill development",
    ...
    "Drama Club": {
        "description": "Rehearse scenes, learn theater techniques, and perform plays",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["sophia@mergington.edu", "benjamin@mergington.edu"]
    },
    "Science Club": {
        "description": "Conduct experiments, discuss discoveries, and explore STEM topics",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["isabella@mergington.edu", "elijah@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice public speaking, argument skills, and compete in debates",
